 ...
 */
class EyufNeed extends ZActiveRecord
{
    #region MVars
    ...
    */
    ...
    public static ?string $title = Azl . 'Потребности в обучении';
   ...
   public function fields()
   {
    ...
    public function config()
    {
        return function (ConfigDB $config) {
            ...
            $config->title = Az::l('Потребности в обучении');
    ...
    public function column()
    {
        ...
        return ZArrayHelper::merge(parent::column(), [
            ...
            'position' => function (FormDb $column) {
                ...
                $column->tooltip = Az::l('Должность кандидата');
                $column->rules = [
                    [
                        'zetsoft\\system\\validate\\ZRequiredValidator',
                    ],
            ...
            'education_field' => function (FormDb $column) {
                ...
                $column->tooltip = Az::l('Oбразование за рубежом кондидата');
                $column->rules = [
                    [
                        'zetsoft\\system\\validate\\ZRequiredValidator',
                    ],
            ...
            'code_specialty' => function (FormDb $column) {
                ...
                $column->tooltip = Az::l('Kод специальности кондидата');
                $column->rules = [
                    [
                        'zetsoft\\system\\validate\\ZRequiredValidator',
                    ],
            ...
            'program' => function (FormDb $column) {
                ...
                $column->tooltip = Az::l('Программы кондидата');
            ...
            'recommendation' => function (FormDb $column) {
                ...
                $column->tooltip = Az::l('Рекомендация кондидата');
                $column->rules = [
                    [
                        'zetsoft\\system\\validate\\ZRequiredValidator',
                    ],
            ...
            'experiance' => function (FormDb $column) {
                ...
                $column->tooltip = Az::l('Стаж работы кондидата (Месяцы)');
            ...
            'phone' => function (FormDb $column) {
                ...
                $column->tooltip = Az::l('Контактный номер телефона кандидата');
                $column->rules = [
                    [
                        'zetsoft\\system\\validate\\ZRequiredValidator',
                    ],
            ...
            'email' => function (FormDb $column) {
                ...
                $column->tooltip = Az::l(' E-mail адрес  кандидата');
                $column->rules = [
                    [
                        'zetsoft\\system\\validate\\ZRequiredValidator',
                    ],
    ...
    */
    ...
    #region Value
                public function value(EyufNeed $model = null)
    {
    ...
    public function event()
    {
        ...
        $event = new Event();
    /*
        $event->beforeDelete = function (EyufNeed $model) {
            return null;
        };

        $event->afterDelete = function (EyufNeed $model) {
            return null;
        };

        $event->beforeSave = function (EyufNeed $model) {
            return null;
        };

        $event->afterSave = function (EyufNeed $model) {
            return null;
        };

        $event->beforeValidate = function (EyufNeed $model) {
            return null;
        };

        $event->afterValidate = function (EyufNeed $model) {
            return null;
        };

        $event->afterRefresh = function (EyufNeed $model) {
            return null;
        };

        $event->afterFind = function (EyufNeed $model) {
            return null;
        };
*/
        return $event;
