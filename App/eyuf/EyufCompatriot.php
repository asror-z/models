 ...
 */
class EyufCompatriot extends ZActiveRecord
{
    #region MVars
    ...
    public function column()
    {
        ...
        return ZArrayHelper::merge(parent::column(), [
            ...
            'phone' => function (FormDb $column) {
                ...
                $column->tooltip = Az::l('Контактный номер соотечественника');
                $column->dbType = dbTypeJsonb;
            ...
            'email' => function (FormDb $column) {
                ...
                $column->tooltip = Az::l('Почтовый адрес соотечественника');
                $column->dbType = dbTypeJsonb;
                $column->widget = ZMultiWidget::class;
                $column->valueWidget = ZMultiViewWidget::class;
                $column->options = [
            ...
            'awards' => function (FormDb $column) {
                ...
                $column->tooltip = Az::l('Достижение соотечественника');
                $column->dbType = dbTypeJsonb;
                $column->widget = ZMultiWidget::class;
                $column->valueWidget = ZMultiViewWidget::class;
                $column->options = [
    ...
    */
    ...
    #region Value
    public function value(EyufCompatriot $model = null)
    {
    ...
    public function event()
    {
        ...
        $event = new Event();
        /*
            $event->beforeDelete = function (EyufCompatriot $model) {
                return null;
            };

            $event->afterDelete = function (EyufCompatriot $model) {
                return null;
            };

            $event->beforeSave = function (EyufCompatriot $model) {
                return null;
            };

            $event->afterSave = function (EyufCompatriot $model) {
                return null;
            };

            $event->beforeValidate = function (EyufCompatriot $model) {
                return null;
            };

            $event->afterValidate = function (EyufCompatriot $model) {
                return null;
            };

            $event->afterRefresh = function (EyufCompatriot $model) {
                return null;
            };

            $event->afterFind = function (EyufCompatriot $model) {
                return null;
            };
    */
        return $event;
