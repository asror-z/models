 ...
 */
class MapsNavigate extends ZActiveRecord
{
    #region MVars
    ...
    */
    ...
    public static ?string $title = Azl . 'Навигация';
    ...
    public function column()
    {
        ...
        return ZArrayHelper::merge(parent::column(), [
            ...
            'location' => function (FormDb $column) {
                ...
                $column->title = Az::l('Навигация');
                $column->tooltip = Az::l('Навигация локации');
    ...
    */
    ...
    #region Value
    public function value(MapsNavigate &$model = null)
    {
        if ($model === null)
            $model = $this;
