 ...
 */
class UserRbacRest extends ZActiveRecord
{
    #region MVars
    ...
    */
    ...
    public static ?string $title = Azl . 'RBAC для REST';
   ...
   public function fields()
   {
    ...
    public function config()
    {
        return function (ConfigDB $config) {
            ...
            $config->title = Az::l('RBAC для REST');
        ...
        return ZArrayHelper::merge(parent::column(), [
            ...
            'models' => function (FormDb $column) {
                ...
                $column->data = function () {
                    return array_combine(Az::$app->smart->migra->scan(), Az::$app->smart->migra->scan());
                };
