 ...
 */
class CoreAnalytics extends ZActiveRecord
{
    #region MVars
    ...
    */
    ...
    #region Value
    public function value(CoreAnalytics &$model = null)
    {
        if ($model === null)
            $model = $this;
    ...
    public function event()
    {
        ...
        $event = new Event();
    /*
        $event->beforeDelete = function (CoreAnalytics $model) {
            return null;
        };

        $event->afterDelete = function (CoreAnalytics $model) {
            return null;
        };

        $event->beforeSave = function (CoreAnalytics $model) {
            return null;
        };

        $event->afterSave = function (CoreAnalytics $model) {
            return null;
        };

        $event->beforeValidate = function (CoreAnalytics $model) {
            return null;
        };

        $event->afterValidate = function (CoreAnalytics $model) {
            return null;
        };

        $event->afterRefresh = function (CoreAnalytics $model) {
            return null;
        };

        $event->afterFind = function (CoreAnalytics $model) {
            return null;
        };
*/
        return $event;
