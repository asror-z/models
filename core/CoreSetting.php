 ...
 */
class CoreSetting extends ZActiveRecord
{
    #region MVars
    ...
    */
    ...
    public static ?string $title = Azl . 'Настройки';
    ...
    */
    ...
    #region Value
    public function value(CoreSetting &$model = null)
    {
        if ($model === null)
            $model = $this;
    ...
    public function event()
    {
        ...
        $event = new Event();
        /*
            $event->beforeDelete = function (CoreSetting $model) {
                return null;
            };

            $event->afterDelete = function (CoreSetting $model) {
                return null;
            };

            $event->beforeSave = function (CoreSetting $model) {
                return null;
            };

            $event->afterSave = function (CoreSetting $model) {
                return null;
            };

            $event->beforeValidate = function (CoreSetting $model) {
                return null;
            };

            $event->afterValidate = function (CoreSetting $model) {
                return null;
            };

            $event->afterRefresh = function (CoreSetting $model) {
                return null;
            };

            $event->afterFind = function (CoreSetting $model) {
                return null;
            };
    */
        return $event;
