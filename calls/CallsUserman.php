 ...
 */
class CallsUserman extends ZActiveRecord
{
    #region MVars
    ...
    public function column()
    {
        ...
        return ZArrayHelper::merge(parent::column(), [
            ...
            'call_cdr_id' => function (FormDb $column) {
                ...
                $column->tooltip = Az::l('Запись звонка');
                $column->dbType = dbTypeInteger;
                $column->rules = [
                    [
                        validatorInteger,
            ...
            'cid_name' => function (FormDb $column) {
                ...
                $column->tooltip = Az::l('Поле имени идентификатора соты (CID)');
            ...
            'cid_num' => function (FormDb $column) {
                ...
                $column->tooltip = Az::l('Поле номера идентификатора соты (CID)');
            ...
            'cid_ani' => function (FormDb $column) {
                ...
                $column->tooltip = Az::l('Поле идентификатора соты ANI');
            ...
            'cid_rdnis' => function (FormDb $column) {
                ...
                $column->tooltip = Az::l('Поле идентификатора соты RDNIS');
            ...
            'cid_dnid' => function (FormDb $column) {
                ...
                $column->tooltip = Az::l('Поле идентификатора соты DNID');
            ...
            'linkedid' => function (FormDb $column) {
                ...
                $column->tooltip = Az::l('ID вызова, охватывает несколько событий');
            ...
            'peer' => function (FormDb $column) {
                ...
                $column->length = 80;
                $column->notNull = true;
                $column->title = Az::l('Название канала соединено с каналом, обозначенным как channame');
