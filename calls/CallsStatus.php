 ...
 */
class CallsStatus extends ZActiveRecord
{
    #region MVars
    ...
    public function column()
    {
        ...
        return ZArrayHelper::merge(parent::column(), [
            ...
            'status' => function (FormDb $column) {
                ...
                $column->tooltip = Az::l('Статус звонка колл центра');
                $column->data = function () {
                    return (new User())->_status;
                };
    ...
    */
    ...
    #region Value
                                public function value(CallsStatus $model = null)
    {
