 ...
 */
class TreeProduct extends ZActiveRecord
{
    #region MVars
    ...
    */
    ...
    public static ?string $title = Azl . 'TreeProduct';
    ...
    */
    ...
    #region Value
    public function value(TreeProduct &$model = null)
    {
        if ($model === null)
            $model = $this;
