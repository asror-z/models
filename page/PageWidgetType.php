 ...
 */
class PageWidgetType extends ZActiveRecord
{
    #region MVars
    ...
    */
    ...
    public static ?string $title = Azl . 'Типы Виджетов';
   ...
   public function fields()
   {
    ...
    public function config()
    {
        return function (ConfigDB $config) {
            ...
            $config->title = Az::l('Типы Виджетов');
...
*/
    ...
    /**
     *
     * Function  getPageWidgetsWithPageWidgetTypeIdMany
     * @return  null|\yii\db\ActiveRecord[]|PageWidget
     */            
    public function getPageWidgetsWithPageWidgetTypeIdMany()
    {
    ...
    /**
     *
     * Function  getPageWidgetsWithPageWidgetTypeId
     * @return  null|\yii\db\ActiveQuery
     */            
    public function getPageWidgetsWithPageWidgetTypeId()
    {
