 ...
 */
class PageView extends ZActiveRecord
{
    #region MVars
    ...
    */
    ...
    public static ?string $title = Azl . 'Виды';
    ...
    */
    ...
    #region Value
    public function value(PageView &$model = null)
    {
        if ($model === null)
            $model = $this;
    ...
    public function event()
    {
        ...
        $event = new Event();
    /*
        $event->beforeDelete = function (PageView $model) {
            return null;
        };

        $event->afterDelete = function (PageView $model) {
            return null;
        };

        $event->beforeSave = function (PageView $model) {
            return null;
        };

        $event->afterSave = function (PageView $model) {
            return null;
        };

        $event->beforeValidate = function (PageView $model) {
            return null;
        };

        $event->afterValidate = function (PageView $model) {
            return null;
        };

        $event->afterRefresh = function (PageView $model) {
            return null;
        };

        $event->afterFind = function (PageView $model) {
            return null;
        };
*/
        return $event;
