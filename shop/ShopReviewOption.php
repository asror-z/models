 ...
 */
class ShopReviewOption extends ZActiveRecord
{
    #region MVars
    ...
    */
    ...
    public static ?string $title = Azl . 'Параметры для отзыва';
   ...
   public function fields()
   {
    ...
    public function config()
    {
        return function (ConfigDB $config) {
            ...
            $config->title = Az::l('Параметры для отзыва');
    ...
    */
    ...
    #region Value
            public function value(ShopReviewOption $model = null)
    {
