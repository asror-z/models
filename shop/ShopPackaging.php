 ...
 */
class ShopPackaging extends ZActiveRecord
{
    #region MVars
    ...
    */
    ...
    public static ?string $title = Azl . 'Тип упаковки';
   ...
   public function fields()
   {
    ...
    public function config()
    {
        return function (ConfigDB $config) {
            ...
            $config->title = Az::l('Тип упаковки');
    ...
    */
    ...
    #region Value
            public function value(ShopPackaging $model = null)
    {
    ...
    /**
     *
     * Function  getShopOrdersWithPackagingMany
     * @return  null|\yii\db\ActiveRecord[]|ShopOrder
     */            
    public function getShopOrdersWithPackagingMany()
    {
    ...
    /**
     *
     * Function  getShopOrdersWithPackaging
     * @return  null|\yii\db\ActiveQuery
     */            
    public function getShopOrdersWithPackaging()
    {
