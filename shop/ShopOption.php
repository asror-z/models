 ...
 * @property int $shop_option_type_id
 ...
 */
class ShopOption extends ZActiveRecord
{
    #region MVars
    ...
    */
    ...
    public static ?string $title = Azl . 'Значения параметров';
   ...
   public function fields()
   {
    ...
    public function config()
    {
        return function (ConfigDB $config) {
            ...
            $config->title = Az::l('Значения параметров');
    ...
    public function column()
    {
        ...
        return ZArrayHelper::merge(parent::column(), [
            ...
            'shop_option_type_id' => function (FormDb $column) {

                $column->index = true;
                $column->title = Az::l('Тип опции');
                $column->tooltip = Az::l('Тип опции');
    ...
    */
    ...
    #region Value
    public function value(ShopOption $model = null)
    {
    ...
    /**
     *
     * Function  getShopOptionType
     * @return bool|\yii\db\ActiveRecord|ShopOptionType|null
     */            
    public function getShopOptionTypeOne()
    {
        return $this->getOne(ShopOptionType::class, [
          'id' => 'shop_option_type_id',
      ]);    
    }
     ...
     */            
    public function getShopOptionType()
    {
        return $this->hasOne(ShopOptionType::class, [
          'id' => 'shop_option_type_id',
      ]);    
    }
