 ...
 */
class ShopRejectCause extends ZActiveRecord
{
    #region MVars
    ...
    */
    ...
    public static ?string $title = Azl . 'Причины отказа';
   ...
   public function fields()
   {
    ...
    public function config()
    {
        return function (ConfigDB $config) {
            ...
            $config->title = Az::l('Причины отказа');
    ...
    */
    ...
    #region Value
            public function value(ShopRejectCause $model = null)
    {
    ...
    /**
     *
     * Function  getShopOrdersWithShopRejectCauseIdMany
     * @return  null|\yii\db\ActiveRecord[]|ShopOrder
     */            
    public function getShopOrdersWithShopRejectCauseIdMany()
    {
    ...
    /**
     *
     * Function  getShopOrdersWithShopRejectCauseId
     * @return  null|\yii\db\ActiveQuery
     */            
    public function getShopOrdersWithShopRejectCauseId()
    {
