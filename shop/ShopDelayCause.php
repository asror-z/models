 ...
 */
class ShopDelayCause extends ZActiveRecord
{
    #region MVars
    ...
    */
    ...
    public static ?string $title = Azl . 'Причины задержек';
   ...
   public function fields()
   {
    ...
    public function config()
    {
        return function (ConfigDB $config) {
            ...
            $config->title = Az::l('Причины задержек');
    ...
    */
    ...
    #region Value
            public function value(ShopDelayCause $model = null)
    {
    ...
    /**
     *
     * Function  getShopOrdersWithShopDelayCauseIdMany
     * @return  null|\yii\db\ActiveRecord[]|ShopOrder
     */            
    public function getShopOrdersWithShopDelayCauseIdMany()
    {
    ...
    /**
     *
     * Function  getShopOrdersWithShopDelayCauseId
     * @return  null|\yii\db\ActiveQuery
     */            
    public function getShopOrdersWithShopDelayCauseId()
    {
