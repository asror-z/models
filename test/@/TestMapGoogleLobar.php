 ...
 */
class TestMapGoogleLobar extends ZActiveRecord
{
    #region MVars
    ...
    public function column()
    {
        ...
        return ZArrayHelper::merge(parent::column(), [
            ...
            'location' => function (FormDb $column) {
                ...
                $column->widget = ZGoogleDb27WidgetLobar::class;
                $column->options = [
						'config' =>[
							'height' => '500',
							'width' => '900',
    ...
    */
    ...
    #region Value
    public function value(TestMapGoogleLobar &$model = null)
    {
        if ($model === null)
            $model = $this;
    ...
    public function event()
    {
        ...
        $event = new Event();
    /*
        $event->beforeDelete = function (TestMapGoogleLobar $model) {
            return null;
        };

        $event->afterDelete = function (TestMapGoogleLobar $model) {
            return null;
        };

        $event->beforeSave = function (TestMapGoogleLobar $model) {
            return null;
        };

        $event->afterSave = function (TestMapGoogleLobar $model) {
            return null;
        };

        $event->beforeValidate = function (TestMapGoogleLobar $model) {
            return null;
        };

        $event->afterValidate = function (TestMapGoogleLobar $model) {
            return null;
        };

        $event->afterRefresh = function (TestMapGoogleLobar $model) {
            return null;
        };

        $event->afterFind = function (TestMapGoogleLobar $model) {
            return null;
        };
*/
        return $event;
