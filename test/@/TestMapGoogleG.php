 ...
 */
class TestMapGoogleG extends ZActiveRecord
{
    #region MVars
    ...
    */
    ...
    #region Value
    public function value(TestMapGoogleG &$model = null)
    {
        if ($model === null)
            $model = $this;
    ...
    public function event()
    {
        ...
        $event = new Event();
    /*
        $event->beforeDelete = function (TestMapGoogleG $model) {
            return null;
        };

        $event->afterDelete = function (TestMapGoogleG $model) {
            return null;
        };

        $event->beforeSave = function (TestMapGoogleG $model) {
            return null;
        };

        $event->afterSave = function (TestMapGoogleG $model) {
            return null;
        };

        $event->beforeValidate = function (TestMapGoogleG $model) {
            return null;
        };

        $event->afterValidate = function (TestMapGoogleG $model) {
            return null;
        };

        $event->afterRefresh = function (TestMapGoogleG $model) {
            return null;
        };

        $event->afterFind = function (TestMapGoogleG $model) {
            return null;
        };
*/
        return $event;
