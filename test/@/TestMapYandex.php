 ...
 */
class TestMapYandex extends ZActiveRecord
{
    #region MVars
    ...
    */
    ...
    #region Value
    public function value(TestMapYandex &$model = null)
    {
        if ($model === null)
            $model = $this;
    ...
    public function event()
    {
        ...
        $event = new Event();
    /*
        $event->beforeDelete = function (TestMapYandex $model) {
            return null;
        };

        $event->afterDelete = function (TestMapYandex $model) {
            return null;
        };

        $event->beforeSave = function (TestMapYandex $model) {
            return null;
        };

        $event->afterSave = function (TestMapYandex $model) {
            return null;
        };

        $event->beforeValidate = function (TestMapYandex $model) {
            return null;
        };

        $event->afterValidate = function (TestMapYandex $model) {
            return null;
        };

        $event->afterRefresh = function (TestMapYandex $model) {
            return null;
        };

        $event->afterFind = function (TestMapYandex $model) {
            return null;
        };
*/
        return $event;
