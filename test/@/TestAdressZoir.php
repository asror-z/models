 ...
 */
class TestAdressZoir extends ZActiveRecord
{
    #region MVars
    ...
    */
    ...
    #region Value
    public function value(TestAdressZoir &$model = null)
    {
        if ($model === null)
            $model = $this;
    ...
    public function event()
    {
        ...
        $event = new Event();
    /*
        $event->beforeDelete = function (TestAdressZoir $model) {
            return null;
        };

        $event->afterDelete = function (TestAdressZoir $model) {
            return null;
        };

        $event->beforeSave = function (TestAdressZoir $model) {
            return null;
        };

        $event->afterSave = function (TestAdressZoir $model) {
            return null;
        };

        $event->beforeValidate = function (TestAdressZoir $model) {
            return null;
        };

        $event->afterValidate = function (TestAdressZoir $model) {
            return null;
        };

        $event->afterRefresh = function (TestAdressZoir $model) {
            return null;
        };

        $event->afterFind = function (TestAdressZoir $model) {
            return null;
        };
*/
        return $event;
