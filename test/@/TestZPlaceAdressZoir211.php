 ...
 */
class TestZPlaceAdressZoir211 extends ZActiveRecord
{
    #region MVars
    ...
    */
    ...
    #region Value
    public function value(TestZPlaceAdressZoir211 &$model = null)
    {
        if ($model === null)
            $model = $this;
    ...
    public function event()
    {
        ...
        $event = new Event();
    /*
        $event->beforeDelete = function (TestZPlaceAdressZoir211 $model) {
            return null;
        };

        $event->afterDelete = function (TestZPlaceAdressZoir211 $model) {
            return null;
        };

        $event->beforeSave = function (TestZPlaceAdressZoir211 $model) {
            return null;
        };

        $event->afterSave = function (TestZPlaceAdressZoir211 $model) {
            return null;
        };

        $event->beforeValidate = function (TestZPlaceAdressZoir211 $model) {
            return null;
        };

        $event->afterValidate = function (TestZPlaceAdressZoir211 $model) {
            return null;
        };

        $event->afterRefresh = function (TestZPlaceAdressZoir211 $model) {
            return null;
        };

        $event->afterFind = function (TestZPlaceAdressZoir211 $model) {
            return null;
        };
*/
        return $event;
