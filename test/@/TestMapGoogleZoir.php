 ...
 */
class TestMapGoogleZoir extends ZActiveRecord
{
    #region MVars
    ...
    public function column()
    {
        ...
        return ZArrayHelper::merge(parent::column(), [
            ...
            'location' => function (FormDb $column) {
                ...
                $column->widget = ZGoogleReadyWidgetZoir::class;
                $column->options = [
						'config' =>[
							'height' => '500',
							'width' => '900',
    ...
    */
    ...
    #region Value
    public function value(TestMapGoogleZoir &$model = null)
    {
        if ($model === null)
            $model = $this;
    ...
    public function event()
    {
        ...
        $event = new Event();
    /*
        $event->beforeDelete = function (TestMapGoogleZoir $model) {
            return null;
        };

        $event->afterDelete = function (TestMapGoogleZoir $model) {
            return null;
        };

        $event->beforeSave = function (TestMapGoogleZoir $model) {
            return null;
        };

        $event->afterSave = function (TestMapGoogleZoir $model) {
            return null;
        };

        $event->beforeValidate = function (TestMapGoogleZoir $model) {
            return null;
        };

        $event->afterValidate = function (TestMapGoogleZoir $model) {
            return null;
        };

        $event->afterRefresh = function (TestMapGoogleZoir $model) {
            return null;
        };

        $event->afterFind = function (TestMapGoogleZoir $model) {
            return null;
        };
*/
        return $event;
