 ...
 */
class TestTerrabayt extends ZActiveRecord
{
    #region MVars
    ...
    public function config()
    {
        return function (ConfigDB $config) {
            ...
            $config->nameValue = 'Заказ клиента №{number} от {created_at}. Ф.И.О {contact_name}';
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                $config->codeValue = function (TestTerrabayt $model) {
    ...
    public function column()
    {
        ...
        return ZArrayHelper::merge(parent::column(), [
            ...
            'contact_name' => function (FormDb $column) {
                ...
                $column->auto = true;
                $column->autoValue = function (TestTerrabayt $model){
                vd('it is autoValue');
                    return 'hello';
                };
                return $column;
            ...
            'place_region_id' => function (FormDb $column) {
                ...
                $column->auto = true;
                $column->autoValue = static function (TestTerrabayt $order) {
...
$column->event = function (TestTerrabayt $model) {
...
$column->defaultValue = 0;
    ...
    */
    ...
    #region Value
    public function value(TestTerrabayt &$model = null)
    {
        if ($model === null) {
            $model = $this;
        }
    ...
    public function event()
    {
        ...
        /*$event->beforeSave = function (TestTerrabayt $model) {
            ...
            if ($this->isNewRecord) {
                $model->status_client = TestTerrabayt::status_client['accepted'];
                $model->status_logistics = TestTerrabayt::status_logistics['new'];
                $model->status_callcenter = TestTerrabayt::status_callcenter['new'];
            } else {
        ...
        /*
        $event->afterSave = function (TestTerrabayt $model) {
