 ...
 */
class TestTerrabayt1 extends ZActiveRecord
{
    #region MVars
    ...
    public function config()
    {
        return function (ConfigDB $config) {
            ...
            $config->nameValue = 'Заказ клиента №{number} от {created_at}. Ф.И.О {contact_name}';
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        $config->codeValue = function (TestTerrabayt1 $model) {
    ...
    public function column()
    {
        ...
        return ZArrayHelper::merge(parent::column(), [
            ...
            'place_region_id' => function (FormDb $column) {
                ...
                $column->auto = true;
                $column->autoValue = static function (TestTerrabayt1 $order) {
...
$column->event = function (TestTerrabayt1 $model) {
...
$column->defaultValue = 0;
            ...
            'total_price' => function (FormDb $column) {
                ...
                $column->readonly = true;
                //$column->auto = true;
                /*$column->autoValue = function (TestTerrabayt1 $model) {
    ...
    */
    ...
    #region Value
    public function value(TestTerrabayt1 &$model = null)
    {
        if ($model === null) {
            $model = $this;
        }

        $TestTerrabaytItems = TestTerrabaytItem::find()
            ->where([
                'shop_order_id' => $model->id
            ])
            ->all();

        /*$TestTerrabaytItem = new TestTerrabaytItem();

        $shopCatalog = ShopCatalog::find()->where(['id' => $TestTerrabaytItem->shop_catalog_id])->all();*/


        if (!$this->emptyOrNullable($TestTerrabaytItems) && !$this->emptyOrNullable($model)) {
            ...
            $collectedItems = collect($TestTerrabaytItems);
            if (empty($model->user_company_ids) || !is_array($model->user_company_ids))
                $model->user_company_ids = [];

            $user_company_ids = ZArrayHelper::merge($model->user_company_ids, ZArrayHelper::getColumn($TestTerrabaytItems, 'user_company_id'));

            $model->shop_element_ids = ZArrayHelper::getColumn($TestTerrabaytItems, 'id');

            $model->user_company_ids = array_unique($user_company_ids);
            if (empty($model->ware_ids) || !is_array($model->ware_ids))
                $model->ware_ids = [];
            $ware_ids = ZArrayHelper::merge($model->ware_ids, ZArrayHelper::getColumn($TestTerrabaytItems, 'ware_id'));
    ...
    public function event()
    {
        ...
        /*$event->beforeDelete = function (TestTerrabaytItem $model) {

            TestTerrabaytItem::deleteAll([
                'shop_order_id' => $model->id
            ]);

        };*/

        /*$event->beforeSave = function (TestTerrabayt1 $model) {
            ...
            if ($this->isNewRecord) {
                $model->status_client = TestTerrabayt1::status_client['accepted'];
                $model->status_logistics = TestTerrabayt1::status_logistics['new'];
                $model->status_callcenter = TestTerrabayt1::status_callcenter['new'];
            } else {
        ...
        /*    $event->beforeSave = function (TestTerrabayt1 $model) {
                if (!$this->isNewRecord) {
                    ...
                    switch ($model->status_logistics) {
                        ...
                        case TestTerrabayt1::status_logistics['buyed']:
        ...
        /*
        $event->afterSave = function (TestTerrabayt1 $model) {
