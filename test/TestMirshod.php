 ...
 */
class TestMirshod extends ZActiveRecord
{
    #region MVars
    ...
    public function config()
    {
        return function (ConfigDB $config) {
            ...
            $config->nameValue = 'Заказ клиента №{number} от {created_at}. Ф.И.О {contact_name}';
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        $config->codeValue = function (TestMirshod $model) {
    ...
    public function column()
    {
        ...
        return ZArrayHelper::merge(parent::column(), [
            ...
            'place_region_id' => function (FormDb $column) {
                ...
                $column->auto = true;
                $column->autoValue = static function (TestMirshod $order) {
...
$column->event = function (TestMirshod $model) {
...
$column->defaultValue = 0;
            ...
            'total_price' => function (FormDb $column) {
                ...
                $column->readonly = true;
                //$column->auto = true;
                /*$column->autoValue = function (TestMirshod $model) {
    ...
    */
    ...
    #region Value
    public function value(TestMirshod &$model = null)
    {
        if ($model === null) {
            $model = $this;
        }

        $TestMirshodItems = TestMirshodItem::find()
            ->where([
                'shop_order_id' => $model->id
            ])
            ->all();

        /*$TestMirshodItem = new TestMirshodItem();

        $shopCatalog = ShopCatalog::find()->where(['id' => $TestMirshodItem->shop_catalog_id])->all();*/


        if (!$this->emptyOrNullable($TestMirshodItems) && !$this->emptyOrNullable($model)) {
            ...
            $collectedItems = collect($TestMirshodItems);
            if (empty($model->user_company_ids) || !is_array($model->user_company_ids))
                $model->user_company_ids = [];

            $user_company_ids = ZArrayHelper::merge($model->user_company_ids, ZArrayHelper::getColumn($TestMirshodItems, 'user_company_id'));

            $model->shop_element_ids = ZArrayHelper::getColumn($TestMirshodItems, 'id');

            $model->user_company_ids = array_unique($user_company_ids);
            if (empty($model->ware_ids) || !is_array($model->ware_ids))
                $model->ware_ids = [];
            $ware_ids = ZArrayHelper::merge($model->ware_ids, ZArrayHelper::getColumn($TestMirshodItems, 'ware_id'));
    ...
    public function event()
    {
        ...
        /*$event->beforeDelete = function (TestMirshodItem $model) {

            TestMirshodItem::deleteAll([
                'shop_order_id' => $model->id
            ]);

        };*/

        /*$event->beforeSave = function (TestMirshod $model) {
            ...
            if ($this->isNewRecord) {
                $model->status_client = TestMirshod::status_client['accepted'];
                $model->status_logistics = TestMirshod::status_logistics['new'];
                $model->status_callcenter = TestMirshod::status_callcenter['new'];
            } else {
        ...
        /*    $event->beforeSave = function (TestMirshod $model) {
                if (!$this->isNewRecord) {
                    ...
                    switch ($model->status_logistics) {
                        ...
                        case TestMirshod::status_logistics['buyed']:
        ...
        /*
        $event->afterSave = function (TestMirshod $model) {
