 ...
 */
class AutoType extends ZActiveRecord
{
    #region MVars
    ...
    */
    ...
    public static ?string $title = Azl . 'Тип транспортного средства';
   ...
   public function fields()
   {
    ...
    public function config()
    {
        return function (ConfigDB $config) {
            ...
            $config->title = Az::l('Тип транспортного средства');
    ...
    */
    ...
    #region Value
                                        public function value(AutoType $model = null)
    {
    ...
    /**
     *
     * Function  getAutosWithAutoTypeIdMany
     * @return  null|\yii\db\ActiveRecord[]|Auto
     */            
    public function getAutosWithAutoTypeIdMany()
    {
    ...
    /**
     *
     * Function  getAutosWithAutoTypeId
     * @return  null|\yii\db\ActiveQuery
     */            
    public function getAutosWithAutoTypeId()
    {
