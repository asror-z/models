 ...
 */
class ChatSubscribe extends ZActiveRecord
{
    #region MVars
    ...
    */
    ...
    public static ?string $title = Azl . 'Подписчики';
    ...
    public function column()
    {
        ...
        return ZArrayHelper::merge(parent::column(), [
            ...
            'email' => function (FormDb $column) {
                ...
                $column->title = Az::l('Электронная почта подписчика');
                $column->tooltip = Az::l('E-mail подписчика');
                $column->rules = [
                    [
                        validatorEmail,
                    ],
    ...
    */
    ...
    #region Value
                    public function value(ChatSubscribe $model = null)
    {
